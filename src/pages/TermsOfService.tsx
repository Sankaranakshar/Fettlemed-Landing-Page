      ...
      <div className="container mx-auto px-4 max-w-4xl relative">
        <FadeIn>
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-5xl font-bold text-pine-900 mb-4 tracking-tight">TERMS OF SERVICE</h1>
          ...
          <div className="bg-white border border-stone-200 rounded-3xl p-8 md:p-12 shadow-sm prose prose-lg max-w-none text-stone-600">
            ...
            {/* Section 1 */}
            <h3 className="text-2xl font-bold text-pine-900 font-sans tracking-tight mb-4 mt-8">1. Acceptance of Terms</h3>
            <p>
              By accessing and using the NamNalam Health Tech platform (including the Patient App, Doctor Clinical Portal, Clinic Management System, and related services) (collectively, the "Services"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you may not use the Services. These Terms apply to all users, whether you are an individual patient ("B2C User"), a healthcare provider such as a doctor or clinic ("B2B User"), or any other entity accessing our Services.
            </p>

            {/* Section 2 */}
            <h3 className="text-2xl font-bold text-pine-900 font-sans tracking-tight mb-4 mt-12">2. Definitions</h3>
            <p>"Services" refers to all platforms, applications, products, and services provided by NamNalam Health Tech Private Limited, including:</p>
            ...
            <p className="mt-4">"Account" means your NamNalam account, created to access and use the Services.</p>
            ...
            {/* Section 3 */}
            <h3 className="text-2xl font-bold text-pine-900 font-sans tracking-tight mb-4 mt-12">3. Eligibility and Account Registration</h3>
            
            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">3.1 Eligibility</h4>
            ...
            {/* Section 4 */}
            <h3 className="text-2xl font-bold text-pine-900 font-sans tracking-tight mb-4 mt-12">4. Use of Services</h3>
            
            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">4.1 Permitted Use</h4>
            ...
            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">4.2 Prohibited Use</h4>
            ...
            <ul className="list-disc list-inside space-y-1">
              ...
              <li>Using the Services in any way that infringes upon the intellectual property rights of NamNalam or third parties</li>
            </ul>

            {/* Section 5 */}
            <h3 className="text-2xl font-bold text-pine-900 font-sans tracking-tight mb-4 mt-12">5. B2B Terms for Healthcare Providers and Clinics</h3>
            
            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">5.1 Professional Responsibilities</h4>
            ...
            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">5.2 Patient Consent</h4>
            <p>You agree to obtain explicit, informed consent from patients before using the Services to access, store, or share their health information. You will use our consent-based framework to request and obtain patient permission before uploading or accessing patient records. You acknowledge that NamNalam's consent framework is designed to empower patients with control over their data.</p>

            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">5.3 Data Ownership</h4>
            ...
            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">5.4 Subscription and Payment</h4>
            <p>B2B Users agree to pay subscription fees as specified in their service agreement. Payment is due in accordance with the agreed billing cycle. Failure to pay may result in suspension or termination of your Account and access to the Services. NamNalam reserves the right to adjust pricing with 30 days' written notice.</p>

            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">5.5 Service Level Agreement</h4>
            <p>NamNalam will use commercially reasonable efforts to maintain the Services with 99% uptime. However, we do not guarantee uninterrupted availability. NamNalam shall not be liable for any downtime or unavailability. You are responsible for implementing backup procedures for critical data.</p>

            {/* Section 6 */}
            <h3 className="text-2xl font-bold text-pine-900 font-sans tracking-tight mb-4 mt-12">6. B2C Terms for Patient Users</h3>
            
            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">6.1 Data Ownership and Control</h4>
            <p>You own all health information you upload or provide to the Patient App. NamNalam acts solely as a custodian of this information. You have the right to access, download, delete, and control sharing of your health data at any time. You may revoke access to any healthcare provider with immediate effect using our consent management features.</p>

            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">6.2 Health Information You Provide</h4>
            <p>You are responsible for the accuracy of health information you provide to the Services. While NamNalam will validate and structure data received from healthcare providers, we do not independently verify the accuracy of any health information. You agree to review information for accuracy and notify us of any errors.</p>

            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">6.3 Consent and Data Sharing</h4>
            <p>The Patient App provides granular consent controls allowing you to explicitly permit or deny access to your health information by specific healthcare providers. Your consent is required before any health information is shared with a doctor or clinic. You may revoke consent at any time, and NamNalam will immediately prevent further access. You acknowledge that you are in complete control of these decisions.</p>

            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">6.4 Family Health Management</h4>
            ...
            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">6.5 Free Service</h4>
            ...
            {/* Section 7 */}
            <h3 className="text-2xl font-bold text-pine-900 font-sans tracking-tight mb-4 mt-12">7. Health Information and Privacy</h3>
            
            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">7.1 Sensitive Health Data</h4>
            <p>You acknowledge that the Services handle sensitive health information. NamNalam implements robust security measures to protect this information. However, no system is completely secure. You are responsible for understanding and accepting the risks associated with digital health information storage and sharing.</p>

            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">7.2 Privacy Policy</h4>
            ...
            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">7.3 Third-Party Providers</h4>
            <p>Health information you enter into the Services may be transmitted to healthcare providers (doctors, clinics, diagnostic labs) with your explicit consent. NamNalam is not responsible for how these third parties handle your information once you have consented to sharing, though we have contractual obligations requiring them to maintain confidentiality.</p>

            {/* Section 8 */}
            <h3 className="text-2xl font-bold text-pine-900 font-sans tracking-tight mb-4 mt-12">8. Intellectual Property Rights</h3>
            
            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">8.1 Ownership</h4>
            <p>NamNalam retains all intellectual property rights in the Services, including the Patient App, Doctor Portal, Clinic Management System, and all related software, features, functionality, and content. You do not acquire any ownership rights in the Services through your use.</p>

            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">8.2 Limited License</h4>
            ...
            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">8.3 User-Generated Content</h4>
            <p>Health information and other data you input into the Services remains your property. However, you grant NamNalam a limited license to use such information to operate and improve the Services, including for de-identified research and analytics purposes, subject to the limitations outlined in our Privacy Policy.</p>

            {/* Section 9 */}
            <h3 className="text-2xl font-bold text-pine-900 font-sans tracking-tight mb-4 mt-12">9. Indemnification</h3>
            <p>You agree to indemnify, defend, and hold harmless NamNalam Health Tech Private Limited, its officers, directors, employees, and agents from any and all claims, damages, losses, and expenses (including reasonable attorneys' fees) arising from: (a) your use of the Services in violation of these Terms; (b) your violation of any applicable law or regulation; (c) your violation of the rights of any third party; or (d) your breach of these Terms. This indemnity does not apply to claims arising solely from NamNalam's negligence or willful misconduct.</p>

            {/* Section 10 */}
            <h3 className="text-2xl font-bold text-pine-900 font-sans tracking-tight mb-4 mt-12">10. Limitation of Liability</h3>
            
            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">10.1 Disclaimer</h4>
            ...
            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">10.2 Limitation of Damages</h4>
            ...
            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">10.3 Cap on Liability</h4>
            ...
            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">10.4 Clinical Disclaimer</h4>
            <p>The Services are not a substitute for professional medical advice, diagnosis, or treatment. Information provided through the Services should not be relied upon as a substitute for consultation with a qualified healthcare professional. NamNalam does not provide medical advice, and all information is for informational purposes only.</p>

            {/* Section 11 */}
            <h3 className="text-2xl font-bold text-pine-900 font-sans tracking-tight mb-4 mt-12">11. Termination</h3>
            
            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">11.1 Termination by User</h4>
            <p>You may terminate your Account and use of the Services at any time by providing written notice to NamNalam. Upon termination, you will lose access to your Account, although you may request a data export before deletion.</p>

            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">11.2 Termination by NamNalam</h4>
            <p>NamNalam may suspend or terminate your Account immediately if: (a) you violate any terms of these Terms of Service; (b) you use the Services illegally or for prohibited purposes; (c) you fail to pay applicable fees; or (d) we determine, in our sole discretion, that your continued use poses a security or legal risk. We will provide notice of termination except in cases of urgent security concerns.</p>

            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">11.3 Data After Termination</h4>
            <p>Upon termination, your Account will be deactivated. You may request a data export within 30 days of termination. After 30 days, your data may be deleted in accordance with our data retention policy. NamNalam is not liable for loss of data after termination.</p>

            {/* Section 12 */}
            <h3 className="text-2xl font-bold text-pine-900 font-sans tracking-tight mb-4 mt-12">12. Governing Law and Dispute Resolution</h3>
            
            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">12.1 Governing Law</h4>
            ...
            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">12.2 Dispute Resolution</h4>
            ...
            {/* Section 15 */}
            <h3 className="text-2xl font-bold text-pine-900 font-sans tracking-tight mb-4 mt-12">15. Severability</h3>
            ...
            {/* Section 16 */}
            <h3 className="text-2xl font-bold text-pine-900 font-sans tracking-tight mb-4 mt-12">16. Entire Agreement</h3>
            <p>These Terms, together with our Privacy Policy and any service agreements, constitute the entire agreement between you and NamNalam regarding your use of the Services. These Terms supersede all prior agreements, understandings, and representations, whether oral or written.</p>

            {/* Section 17 */}
            <h3 className="text-2xl font-bold text-pine-900 font-sans tracking-tight mb-4 mt-12">17. Additional B2B Terms for Healthcare Providers</h3>
            
            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">17.1 Confidential Information</h4>
            ...
            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">17.2 Compliance and Audits</h4>
            <p>B2B Users agree to comply with all healthcare laws and regulations and to cooperate with NamNalam in any compliance audits, security assessments, or regulatory inquiries. NamNalam reserves the right to audit usage of the Services to ensure compliance with these Terms and applicable laws.</p>

            <h4 className="text-lg font-bold text-pine-800 mt-6 mb-3">17.3 Prohibited Clinical Practices</h4>
            <p>B2B Users agree not to use the Services in any way that constitutes medical malpractice, ethical violations, or unlicensed practice of medicine. NamNalam reserves the right to suspend service to any healthcare provider suspected of such violations.</p>

            {/* Section 18 */}
            <h3 className="text-2xl font-bold text-pine-900 font-sans tracking-tight mb-4 mt-12">18. Acknowledgment</h3>
            <p>By using NamNalam Health Tech's Services, you acknowledge that you have read and understood these Terms of Service and agree to be bound by them. You further acknowledge that you understand the risks associated with digital health information management and accept those risks in exchange for the convenience and benefits the Services provide.</p>
