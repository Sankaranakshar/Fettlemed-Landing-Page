        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <FadeIn>
            <div className="text-center mb-12">
              <h2 className="text-2xl font-medium text-stone-900">How data ownership works</h2>
            </div>
            ...
            <div className="bg-white rounded-[2rem] border border-stone-200 p-8 md:p-12 shadow-sm flex flex-col md:flex-row items-center justify-between gap-8">
               <div className="flex flex-col items-center text-center max-w-[200px]">
                  ...
                  <h3 className="font-medium text-pine-900 text-lg mb-2">1. You</h3>
               ...
               <div className="hidden md:flex flex-col items-center justify-center px-4 w-full relative">
                 ...
                 <div className="bg-white px-4 py-1.5 rounded-full border border-stone-200 font-medium text-xs uppercase tracking-wider text-stone-500 relative z-10 whitespace-nowrap shadow-sm">Grant Access</div>
               </div>
               <div className="md:hidden flex flex-col items-center justify-center py-4 h-full relative">
                 ...
                 <div className="bg-white px-4 py-1.5 rounded-full border border-stone-200 font-medium text-xs uppercase tracking-wider text-stone-500 relative z-10 shadow-sm">Grant Access</div>
               </div>
               ...
               <div className="flex flex-col items-center text-center max-w-[200px]">
                  ...
                  <h3 className="font-medium text-pine-900 text-lg mb-2">2. Your Doctor</h3>
                  <p className="text-sm font-medium text-stone-500 leading-relaxed">Doctor receives strict, temporary access to review.</p>
               </div>

               <div className="hidden md:flex flex-col items-center justify-center px-4 w-full relative">
                 <div className="h-0.5 w-full bg-stone-200 absolute top-1/2 -translate-y-1/2"></div>
                 <div className="bg-white px-4 py-1.5 rounded-full border border-stone-200 font-medium text-xs uppercase tracking-wider text-stone-500 relative z-10 whitespace-nowrap shadow-sm">Revoke</div>
               </div>
               <div className="md:hidden flex flex-col items-center justify-center py-4 h-full relative">
                 <div className="w-0.5 h-full min-h-[40px] bg-stone-200 absolute left-1/2 -translate-x-1/2"></div>
                 <div className="bg-white px-4 py-1.5 rounded-full border border-stone-200 font-medium text-xs uppercase tracking-wider text-stone-500 relative z-10 shadow-sm">Revoke</div>
               </div>
               ...
               <div className="flex flex-col items-center text-center max-w-[200px]">
                  ...
                  <h3 className="font-medium text-pine-900 text-lg mb-2">3. End Use</h3>
        ...
        <div className="container mx-auto px-4 md:px-8 max-w-[1200px] flex flex-col lg:flex-row gap-12">
           <div className="lg:w-1/4 hidden lg:block">
              <div className="sticky top-32 space-y-4">
                 <h2 className="text-sm font-medium tracking-widest uppercase text-stone-400 mb-6">Security Stack</h2>
                 <a href="#encryption" className="block text-sm font-medium text-stone-600 hover:text-pine-600">Encryption</a>
                 <a href="#consent" className="block text-sm font-medium text-stone-600 hover:text-pine-600">Consent architecture</a>
                 <a href="#access" className="block text-sm font-medium text-stone-600 hover:text-pine-600">Access controls</a>
                 <a href="#compliance" className="block text-sm font-medium text-stone-600 hover:text-pine-600">Compliance</a>
                 <a href="#sovereignty" className="block text-sm font-medium text-stone-600 hover:text-pine-600">Data sovereignty</a>
              </div>
           </div>
             ...
             <div className="space-y-16">
                <div id="encryption"><FadeIn delay={0.1} className="scroll-mt-32">
                   <div className="flex gap-6 items-start">
                     ...
                     <div>
                       <h3 className="text-2xl font-medium text-stone-900 mb-3">Encryption</h3>
                ...
                <div id="consent"><FadeIn delay={0.1} className="scroll-mt-32">
                   <div className="flex gap-6 items-start">
                     ...
                     <div>
                       <h3 className="text-2xl font-medium text-stone-900 mb-3">Consent architecture</h3>
                ...
                <div id="access"><FadeIn delay={0.1} className="scroll-mt-32">
                   <div className="flex gap-6 items-start">
                     ...
                     <div>
                       <h3 className="text-2xl font-medium text-stone-900 mb-3">Access controls</h3>
                ...
                <div id="compliance"><FadeIn delay={0.1} className="scroll-mt-32">
                   <div className="flex gap-6 items-start">
                     ...
                     <div>
                       <h3 className="text-2xl font-medium text-stone-900 mb-3">Compliance</h3>
                ...
                <div id="sovereignty"><FadeIn delay={0.1} className="scroll-mt-32">
                   <div className="flex gap-6 items-start">
                     ...
                     <div>
                       <h3 className="text-2xl font-medium text-stone-900 mb-3">Data sovereignty</h3>
