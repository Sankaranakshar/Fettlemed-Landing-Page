  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 max-w-[1000px]">
        <Breadcrumbs />
        <h1 className="text-4xl md:text-5xl font-bold text-stone-900 mb-16 tracking-tight border-b pb-8 text-balance">Doctor Portal Features</h1>

        <div className="grid md:grid-cols-2 gap-12">
           <div>
             <h3 className="text-2xl font-bold text-stone-900 mb-4 flex gap-3"><CheckCircle2 className="w-6 h-6 text-pine-600 mt-1 shrink-0"/> Smart patient history dashboard</h3>
           ...
           <div>
             <h3 className="text-2xl font-bold text-stone-900 mb-4 flex gap-3"><CheckCircle2 className="w-6 h-6 text-pine-600 mt-1 shrink-0"/> E-prescriptions</h3>
           ...
           <div>
             <h3 className="text-2xl font-bold text-stone-900 mb-4 flex gap-3"><CheckCircle2 className="w-6 h-6 text-pine-600 mt-1 shrink-0"/> Consultation notes</h3>
           ...
           <div>
             <h3 className="text-2xl font-bold text-stone-900 mb-4 flex gap-3"><CheckCircle2 className="w-6 h-6 text-pine-600 mt-1 shrink-0"/> Clinical decision support (Phase 2)</h3>
           ...
           <div>
             <h3 className="text-2xl font-bold text-stone-900 mb-4 flex gap-3"><CheckCircle2 className="w-6 h-6 text-pine-600 mt-1 shrink-0"/> Lab integration</h3>
