      ...
      <div className="container mx-auto px-4 max-w-4xl relative">
        <FadeIn>
          ...
          <div className="bg-white border border-stone-200 rounded-3xl p-8 md:p-12 shadow-sm prose prose-lg max-w-none text-stone-600">
            ...
            <h4 className="text-lg font-medium text-pine-800 mt-6 mb-3">3.2 Personal Information You Provide</h4>
            <ul className="list-disc list-inside space-y-1">
            ...
            <h4 className="text-lg font-medium text-pine-800 mt-6 mb-3">3.3 Information Collected Automatically</h4>
            <ul className="list-disc list-inside space-y-1">
            ...
            <h4 className="text-lg font-medium text-pine-800 mt-6 mb-3">3.4 Information from Healthcare Providers</h4>
            <ul className="list-disc list-inside space-y-1">
            ...
            <h4 className="text-lg font-medium text-pine-800 mt-6 mb-3">3.5 Information from Third Parties</h4>
            <ul className="list-disc list-inside space-y-1">
            ...
            <h4 className="text-lg font-medium text-pine-800 mt-6 mb-3">4.2 To Support Clinical Care</h4>
            <ul className="list-disc list-inside space-y-1">
            ...
            <h4 className="text-lg font-medium text-pine-800 mt-6 mb-3">4.3 To Communicate with You</h4>
            <ul className="list-disc list-inside space-y-1">
            ...
            <h4 className="text-lg font-medium text-pine-800 mt-6 mb-3">4.4 For Analytics and Improvement</h4>
            <ul className="list-disc list-inside space-y-1">
            ...
            <h4 className="text-lg font-medium text-pine-800 mt-6 mb-3">4.5 For Security and Compliance</h4>
            <ul className="list-disc list-inside space-y-1">
            ...
            <h4 className="text-lg font-medium text-pine-800 mt-6 mb-3">5.2 With Service Providers</h4>
            ...
            <h4 className="text-lg font-medium text-pine-800 mt-6 mb-3">5.3 With Family Members</h4>
            ...
            <h4 className="text-lg font-medium text-pine-800 mt-6 mb-3">5.4 For Legal Compliance</h4>
            ...
            <h4 className="text-lg font-medium text-pine-800 mt-6 mb-3">5.5 De-Identified Research (With Ethical Oversight)</h4>
            ...
            <h4 className="text-lg font-medium text-pine-800 mt-6 mb-3">5.6 Business Transfers</h4>
            ...
            <h4 className="text-lg font-medium text-pine-800 mt-6 mb-3">6.2 Access Audit Trail</h4>
            ...
            <h4 className="text-lg font-medium text-pine-800 mt-6 mb-3">6.3 Data Access and Correction</h4>
            ...
            <h4 className="text-lg font-medium text-pine-800 mt-6 mb-3">6.4 Communication Preferences</h4>
            ...
            <h4 className="text-lg font-medium text-pine-800 mt-6 mb-3">6.5 Cookie and Tracking Choices</h4>
            ...
            <h4 className="text-lg font-medium text-pine-800 mt-6 mb-3">7.2 Organizational Safeguards</h4>
            <ul className="list-disc list-inside space-y-1">
            ...
            <h4 className="text-lg font-medium text-pine-800 mt-6 mb-3">7.3 Incident Response</h4>
            ...
            <h4 className="text-lg font-medium text-pine-800 mt-6 mb-3">12.2 India Data Protection Laws</h4>
            ...
            <h4 className="text-lg font-medium text-pine-800 mt-6 mb-3">12.3 Additional Rights for Certain Jurisdictions</h4>
            ...
            <h4 className="text-lg font-medium text-pine-800 mt-6 mb-3">13.2 Right to Rectification</h4>
            ...
            <h4 className="text-lg font-medium text-pine-800 mt-6 mb-3">13.3 Right to Deletion</h4>
            ...
            <h4 className="text-lg font-medium text-pine-800 mt-6 mb-3">13.4 Right to Data Portability</h4>
            ...
            <h4 className="text-lg font-medium text-pine-800 mt-6 mb-3">13.5 Right to Object</h4>
