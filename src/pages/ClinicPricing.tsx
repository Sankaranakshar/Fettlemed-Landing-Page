    ...
    <>
      ...
      <div className="container mx-auto px-4 max-w-[1200px]">
        ...
        <div className="text-center max-w-[800px] mx-auto mb-16">
          <h1 className="text-4xl md:text-5xl font-medium text-stone-900 mb-6 tracking-tight">Plans built for clinics of every size.</h1>
        ...
        <div className="grid md:grid-cols-3 gap-8">
           <div className="bg-white border border-stone-200 rounded-3xl p-8 shadow-sm flex flex-col">
             <h3 className="text-2xl font-medium text-stone-900 mb-2">Starter</h3>
             <p className="text-stone-500 mb-6">For solo GP practices.</p>
             <div className="mb-8 font-medium text-stone-900 border-b pb-6">1 practitioner, up to 2 staff accounts.</div>
           ...
           <div className="bg-stone-900 border border-stone-800 rounded-3xl p-8 shadow-md flex flex-col text-white relative">
             <div className="absolute top-0 left-1/2 transform -transtone-x-1/2 -transtone-y-1/2 bg-pine-500 text-white px-4 py-1 rounded-full text-xs font-medium uppercase tracking-widest">Most Popular</div>
             ...
             <div className="mb-8 font-medium text-stone-200 border-b border-stone-700 pb-6">2-5 doctors.</div>
             <p className="text-pine-400 text-sm font-medium mb-4 uppercase tracking-wider">All Starter features, plus:</p>
           ...
           <div className="bg-white border border-stone-200 rounded-3xl p-8 shadow-sm flex flex-col">
             <h3 className="text-2xl font-medium text-stone-900 mb-2">Enterprise</h3>
             <p className="text-stone-500 mb-6">For polyclinics and multi-location practices.</p>
             <div className="mb-8 font-medium text-stone-900 border-b pb-6">Custom sizing.</div>
             <p className="text-stone-900 text-sm font-medium mb-4 uppercase tracking-wider">All Growth features, plus:</p>
             <ul className="space-y-4 mb-8 flex-grow">
        ...
        <div className="mt-20 bg-pine-50 border border-pine-100 rounded-3xl p-8 md:p-12 text-center max-w-[800px] mx-auto">
           <h2 className="text-3xl font-medium text-pine-900 mb-4">Founding member pricing</h2>
