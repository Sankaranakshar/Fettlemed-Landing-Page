    ...
    <>
      ...
      <div className="flex flex-col w-full min-h-[80vh] bg-surface-50 items-center justify-center p-6 text-center">
        <FadeIn>
          ...
          <h1 className="text-6xl font-black text-pine-900 mb-4 tracking-tighter">404</h1>
          <h2 className="text-2xl font-bold text-stone-800 mb-6 px-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/" className="w-full sm:w-auto">
              <Button size="lg" className="w-full sm:w-auto h-14 px-8 rounded-xl font-bold flex items-center gap-2">
                <Home className="w-5 h-5" /> Back to Home
              </Button>
            </Link>
            <Link to="/patient-app" className="w-full sm:w-auto">
              <Button variant="outline" size="lg" className="w-full sm:w-auto h-14 px-8 rounded-xl border-stone-200 text-stone-600 hover:text-pine-900 font-bold flex items-center gap-2">
