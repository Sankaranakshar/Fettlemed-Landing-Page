  ...
  return (
    <section className="py-24 md:py-32 bg-pine-900 text-white overflow-hidden relative">
       ...
       <div className="container mx-auto px-6 max-w-6xl relative z-10 flex flex-col items-center text-center">
          <FadeIn>
            <h2 className="text-4xl md:text-6xl font-medium tracking-tight mb-16 text-balance">One place for your complete health record.</h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 justify-center gap-6 mb-16 max-w-5xl mx-auto text-left">
               ...
               <div className="bg-white/5 border border-white/10 rounded-2xl p-6 pb-8 relative overflow-hidden lg:col-span-1 md:col-span-2">
                  ...
                  <h3 className="text-xl font-medium mb-6 flex items-center gap-2"><Smartphone className="w-5 h-5 text-accent-400" /> For Patients</h3>
                  <ul className="space-y-4 font-medium text-pine-100">
                    <li className="flex gap-3 items-start"><CheckCircle2 className="w-5 h-5 text-accent-500 shrink-0 mt-0.5" /> <span><span className="text-white font-medium">You control</span> who sees your data</span></li>
               ...
               <div className="bg-white/5 border border-white/10 rounded-2xl p-6 pb-8 relative overflow-hidden">
                  ...
                  <h3 className="text-xl font-medium mb-6 flex items-center gap-2"><Stethoscope className="w-5 h-5 text-pine-400" /> For Doctors</h3>
                  <ul className="space-y-4 font-medium text-pine-100">
               ...
               <div className="bg-white/5 border border-white/10 rounded-2xl p-6 pb-8 relative overflow-hidden">
                  ...
                  <h3 className="text-xl font-medium mb-6 flex items-center gap-2"><Building2 className="w-5 h-5 text-pine-400" /> For Clinics</h3>
                  <ul className="space-y-4 font-medium text-pine-100">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Button variant="animated" size="lg" onClick={() => setModalOpen(true)} className="w-full sm:w-auto h-14 px-10 text-lg bg-white hover:bg-stone-100 text-pine-900 rounded-xl font-medium shadow-lg">
                Join Waitlist
              </Button>
