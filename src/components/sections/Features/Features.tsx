...
export const Features = () => {
  ...
  return (
    <section className="py-16 md:py-20 bg-pine-900 text-white overflow-hidden relative">
       ...
       <div className="container mx-auto px-6 max-w-6xl relative z-10 flex flex-col items-center text-center">
          <FadeIn>
            <h2 className="text-4xl md:text-5xl font-medium tracking-tight mb-10 text-balance">One place for your complete health record.</h2>

            <div className="grid md:grid-cols-2 lg:grid-cols-3 justify-center gap-6 mb-10 max-w-5xl mx-auto text-left">
               {/* For Patients */}
               <div className="bg-white/5 border border-white/10 rounded-2xl p-6 pb-8 relative overflow-hidden lg:col-span-1 md:col-span-2">
                  ...
                  <h3 className="text-xl font-medium mb-6 flex items-center gap-2"><Smartphone className="w-5 h-5 text-pine-300" /> For Patients</h3>
