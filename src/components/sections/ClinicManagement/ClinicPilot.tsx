...
<p className="font-medium text-white">If you want to talk through whether Fettlemed suits your clinic before joining, write to <a href="mailto:hello@fettlemed.com" className="underline hover:text-pine-200">hello@fettlemed.com</a>.</p>
             </div>
