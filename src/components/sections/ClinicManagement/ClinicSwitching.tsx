    ...
    <section className="py-24 bg-white border-b border-stone-100">
       <div className="container mx-auto px-4 md:px-8 max-w-4xl">
          ...
          <div className="space-y-8">
             <FadeIn delay={0.1}>
                <h3 className="text-xl font-medium text-pine-900 mb-2">You do not switch everything at once</h3>
             ...
             <FadeIn delay={0.2}>
                <h3 className="text-xl font-medium text-pine-900 mb-2">Your existing patients are not disrupted</h3>
             ...
             <FadeIn delay={0.3}>
                <h3 className="text-xl font-medium text-pine-900 mb-2">Your staff will not have a bad week</h3>
             ...
             <FadeIn delay={0.4}>
                <h3 className="text-xl font-medium text-pine-900 mb-2">No new hardware</h3>
             ...
             <FadeIn delay={0.5}>
                <h3 className="text-xl font-medium text-pine-900 mb-2">If the clinic changes its mind</h3>
             ...
             <FadeIn delay={0.6}>
                <h3 className="text-xl font-medium text-pine-900 mb-2">Branch management</h3>
