...
const items = [
  ...
  },
  {
    ...
    body: "today, this week, this month. Know exactly how the clinic is performing.",
  },
  {
    heading: "No-show rates",
    body: "tracked automatically, so you can adjust reminder timing or slot allocation when it matters.",
  },
];
    ...
    <section className="py-12 md:py-16 bg-pine-900 text-white relative overflow-hidden flex flex-col items-center">
       ...
       <div className="container mx-auto px-4 md:px-8 max-w-4xl relative z-10">
          ...
          <div className="bg-pine-800/50 border border-pine-700/50 rounded-3xl p-8 md:p-12 backdrop-blur-sm">
             ...
             <div className="mt-10 p-6 bg-white border border-stone-200 rounded-2xl text-center">
                <p className="text-pine-900 font-medium text-lg md:text-xl">Every number above lives in one dashboard. No spreadsheets. No asking the front desk. No waiting until month end.</p>
             </div>
          </div>
       </div>
    </section>
