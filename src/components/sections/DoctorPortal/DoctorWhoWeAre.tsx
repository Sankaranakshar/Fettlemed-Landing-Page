      ...
      <div className="container mx-auto px-6 max-w-5xl">
        <FadeIn className="mb-8 text-center">
          ...
          <p className="text-dim text-base font-medium mt-3 max-w-xl mx-auto leading-relaxed">
            Built by people who have worked in Indian clinical environments — not a team that read about them. Every workflow is reviewed by our healthcare professionals before it ships.
          </p>
        </FadeIn>
        ...
        <FadeIn delay={0.3} className="bg-pine-900 rounded-2xl px-7 py-5 text-center">
          <p className="text-pine-100 font-medium text-base md:text-lg leading-relaxed">
            "We are not building for the doctor of the future. We are building for the doctor practicing in India today."
          </p>
