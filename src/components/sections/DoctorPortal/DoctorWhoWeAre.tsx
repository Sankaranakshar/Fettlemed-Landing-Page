       ...
       <div className="container mx-auto px-4 md:px-8 max-w-4xl text-center">
          <FadeIn>
             ...
             <div className="space-y-6 text-lg text-stone-600 font-medium leading-relaxed text-left md:text-center">
                ...
                <p className="text-pine-900 font-bold text-xl mt-8">"We are not building for the doctor of the future. We are building for the doctor practicing in India today."</p>
             </div>
          </FadeIn>
       </div>
    </section>
