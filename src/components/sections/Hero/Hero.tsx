        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-8">
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            <FadeIn noYOffset eager>
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-medium leading-[1.08] tracking-tight mb-8 text-pine-950 drop-shadow-sm">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center lg:justify-start flex-wrap mb-10">
                <div className="flex flex-wrap gap-x-6 gap-y-2 text-sm font-medium text-stone-600 bg-surface-50 px-5 py-3 rounded-2xl border border-stone-200 shadow-sm w-full sm:w-auto justify-center">
              ...
              <div className="flex flex-col items-center lg:items-start gap-4 justify-center lg:justify-start">
                <Button
                  ...
                  className="w-full sm:w-auto h-14 px-10 text-lg bg-accent-600 hover:bg-accent-700 text-white rounded-xl font-medium shadow-lg shadow-accent-600/20"
                >
                  Join Waitlist
                </Button>
              </div>
