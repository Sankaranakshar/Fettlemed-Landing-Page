          ...
          <div className="w-full md:w-1/2 text-center md:text-left">
            <FadeIn noYOffset eager>
              ...
              <div className="flex flex-wrap gap-2 justify-center md:justify-start mb-4 md:mb-5 lg:mb-4">
                <span className="flex items-center gap-1.5 text-xs lg:text-sm font-medium text-dim bg-white px-3 py-1.5 lg:px-4 lg:py-2 rounded-full border border-pine-100 shadow-sm"><Lock className="w-3.5 h-3.5 lg:w-4 lg:h-4 text-pine-600"/> Secure & Private</span>
                <span className="flex items-center gap-1.5 text-xs lg:text-sm font-medium text-dim bg-white px-3 py-1.5 lg:px-4 lg:py-2 rounded-full border border-pine-100 shadow-sm"><ShieldCheck className="w-3.5 h-3.5 lg:w-4 lg:h-4 text-pine-600"/> You own your records</span>
                <span className="flex items-center gap-1.5 text-xs lg:text-sm font-medium text-dim bg-white px-3 py-1.5 lg:px-4 lg:py-2 rounded-full border border-pine-100 shadow-sm"><BadgeCheck className="w-3.5 h-3.5 lg:w-4 lg:h-4 text-pine-600"/> Your data stays yours</span>
              </div>
