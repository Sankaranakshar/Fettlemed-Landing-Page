      ...
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <FadeIn>
             ...
             <div className="space-y-6 mt-10">
               <div className="flex gap-4 items-start">
                  <div className="w-8 h-8 rounded-full bg-stone-100 flex items-center justify-center flex-shrink-0 mt-1"><span className="text-stone-500 font-bold">1</span></div>
                  <div>
                    <p className="text-xl md:text-2xl font-bold text-pine-900 mb-2">The Doctor's "Bad Day"</p>
               ...
               <div className="flex gap-4 items-start">
                  <div className="w-8 h-8 rounded-full bg-stone-100 flex items-center justify-center flex-shrink-0 mt-1"><span className="text-stone-500 font-bold">2</span></div>
                  <div>
                    <p className="text-xl md:text-2xl font-bold text-pine-900 mb-2">The Patient's Struggle</p>
          ...
          <FadeIn delay={0.2} className="bg-surface-50 p-10 md:p-16 rounded-[2rem] border border-stone-200">
             <h3 className="text-2xl md:text-3xl font-bold text-pine-900 mb-6">Disconnected data delays healthcare.</h3>
             ...
             <p className="text-lg text-stone-600 leading-relaxed font-medium">Fettlemed connects everything into one continuous record that <span className="font-bold text-pine-900 border-b border-accent-600">follows you</span> wherever you go.</p>
          </FadeIn>
        </div>
      </div>
    </section>
