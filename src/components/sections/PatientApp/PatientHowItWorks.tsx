    ...
    <section className="py-24 bg-surface-50 border-b border-stone-100">
       <div className="container mx-auto px-4 md:px-8 max-w-4xl">
          <FadeIn className="text-center mb-16">
             <h2 className="text-3xl md:text-5xl font-bold text-pine-900 tracking-tight text-balance">How it works</h2>
          </FadeIn>

          <div className="space-y-12">
             {/* Step 1 */}
             <FadeIn delay={0.1} className="flex flex-col md:flex-row gap-8 items-start">
                <div className="w-16 h-16 bg-white border border-stone-200 shadow-sm rounded-full flex items-center justify-center text-2xl font-black text-pine-900 shrink-0">1</div>
                <div>
                   <h3 className="text-2xl font-bold text-pine-900 mb-3 tracking-tight">Create your health profile</h3>
             ...
             <FadeIn delay={0.3} className="flex flex-col md:flex-row gap-8 items-start">
                <div className="w-16 h-16 bg-white border border-stone-200 shadow-sm rounded-full flex items-center justify-center text-2xl font-black text-pine-900 shrink-0">3</div>
                <div>
                   <h3 className="text-2xl font-bold text-pine-900 mb-3 tracking-tight">Share with confidence</h3>
