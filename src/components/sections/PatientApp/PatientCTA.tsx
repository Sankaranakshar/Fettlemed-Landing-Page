       ...
       <div className="container mx-auto px-4 md:px-8 max-w-4xl text-center">
          <FadeIn>
             ...
             <div className="flex flex-col items-center justify-center gap-6">
               <Button variant="animated" size="lg" onClick={() => setModalOpen(true)} className="bg-accent-600 hover:bg-accent-700 text-white h-14 px-12 text-lg rounded-xl font-medium shadow-lg shadow-accent-600/20">
                 Get early access
               </Button>

               <div className="flex items-center gap-4 text-sm font-medium text-stone-500 mt-4">
